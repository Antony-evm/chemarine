...
import QualityProductsComponent from '@/components/home_page/QualityProductsComponent.vue';
import ExperienceComponent from '@/components/home_page/ExperienceComponent.vue';
import SupportComponent from '@/components/home_page/SupportComponent.vue';
