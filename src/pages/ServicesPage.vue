<template>
    <div class="snap-start min-h-screen flex items-center justify-center px-4 py-16">
        <div class="max-w-3xl w-full text-justify space-y-6">
            <h1 class="font-bold text-center">Services</h1>
            ...
            <p>We can offer the calibration of your gas detectors either to our workshop or on board your vessel.
                Our effort is to offer fastest response time and minimum turnaround without compromising the quality of
